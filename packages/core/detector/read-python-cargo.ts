 ...
 * to match `pipAdapter.listDirectDeps` output. Grounded in the frameworks the
 * codebase's python live-generation + deps-hash tests already reference
 * (django, flask, fastapi, sqlalchemy — kickoff §1 / spec §7). Additive scope:
