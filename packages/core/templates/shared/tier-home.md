...
> [`.claude/skills/night-mode/SKILL.md`](../../.claude/skills/night-mode/SKILL.md) «Overnight
...
- `.claude/skills/night-mode/SKILL.md:15` — «Claude with no Fable → [advisor Opus, executor
  Sonnet, cheap Haiku]» → row 3 (no Fable) evidence + row 2 (window slides) evidence.
- `.claude/skills/night-mode/SKILL.md:17` — non-CC portability table → row 4 evidence.
