...
| C13 | TRUST | Frontmatter complete: `title`, `description`, `kind`, `sources:` (the D26 mapping input; derived per D-Q18, authors add but never remove) | GATE(frontmatter schema, `docs-check.mjs`; D31 R18 Zod backstop at the landing build) | all |
