...
| `story` | factory | auto | Use when work is done / a PR was pushed, or when the user asks to recap what was done — «расскажи что сделали», «расскажи историю», «что изменилось за сессию», story, recap. | not installed on any lane (no-lane) |
