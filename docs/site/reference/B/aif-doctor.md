...
|---|---|---|
| Look | read-only probes: the runtime's health address, its task list, `docker ps`, container logs | no |
| Name | match what it saw against a catalogue of eight failures the authors observed live | no |
