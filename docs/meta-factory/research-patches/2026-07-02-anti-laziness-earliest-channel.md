...
- **[SSOT #189](../../../docs/meta-factory/prior-art-evaluations.md)** — ADAPT verdict recording the 6-item BFR-consult (REUSE inject-channel + ADAPT dedup-first; REJECT code-clone tools; REFERENCE Superpowers manual prior-art).
