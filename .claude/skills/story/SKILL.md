...
<!-- @harness-posture: cc-native-with-fallback — !shell injection (SKILL.md:18) + Stop-hook auto-emission (SKILL.md:21) are CC-native; degradation: run helpers/emit-story-prompt.sh manually / tell the story on request -->
