...
A [skill](../../../../../docs/site/terms.md#skill) is how getff talks to your AI agent. Rules and gates stop
...
| ----------------------------- | --------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | --------------------------------------------------- |
| `ai-doc`                      | core      | auto       | Use when creating or fixing an AI-facing doc/rule/skill/agent in this repo (SKILL.md, .claude/rules/_, agents/_, CLAUDE.md, AGENTS.md) — to apply the project's context-hygiene + rule-as-test + AI-agnostic authoring standard. Triggers: write a rule, author a skill, fix a doc, doc-authority header, progressive disclosure, channel selection, документация, правило, скилл.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | core: react-native, react-next, react-spa, ts-server         |
...
- **Tier** is the [depth](../../../../../docs/site/terms.md#depth) that installs the skill. The script still
...
- **Ships-to** is measured from a default install of each stack. A default install
  ...
  is wider than the [glossary meaning](../../../../../docs/site/terms.md#lane).
...
Each skill gets its own page with a [fact card](../../../../../docs/site/terms.md#fact-card), a plain
explanation, and the files that prove each fact. The table does not link to those pages
yet, so here they are by [depth](../../../../../docs/site/terms.md#depth). Start with [getff](../../../../../docs/site/reference/B/getff.md): it
is the one skill every other skill builds on.

- **`core`:** [getff](../../../../../docs/site/reference/B/getff.md), [ai-doc](../../../../../docs/site/reference/B/ai-doc.md),
  [rule-research](../../../../../docs/site/reference/B/rule-research.md), [rule-tests](../../../../../docs/site/reference/B/rule-tests.md),
  [template-audit](../../../../../docs/site/reference/B/template-audit.md), [tool-bootstrapping](../../../../../docs/site/reference/B/tool-bootstrapping.md)
- **`env` adds:** [arch](../../../../../docs/site/reference/B/arch.md), [night-mode](../../../../../docs/site/reference/B/night-mode.md),
  [orchestrator](../../../../../docs/site/reference/B/orchestrator.md), [pipeline](../../../../../docs/site/reference/B/pipeline.md),
  [reviewer](../../../../../docs/site/reference/B/reviewer.md)
- **`factory` adds:** [aif-doctor](../../../../../docs/site/reference/B/aif-doctor.md),
  [claude-glm-executor-handoff](../../../../../docs/site/reference/B/claude-glm-executor-handoff.md),
  [dispatcher](../../../../../docs/site/reference/B/dispatcher.md), [harvest](../../../../../docs/site/reference/B/harvest.md), [story](../../../../../docs/site/reference/B/story.md)
- **Never installed, used by getff on itself:** [docs-author](../../../../../docs/site/reference/B/docs-author.md),
  [self-reflection](../../../../../docs/site/reference/B/self-reflection.md)
...
On a `ts-server` project installed at the `core` [depth](../../../../../docs/site/terms.md#depth), you get:
...
`env`. The guide [Add the design and review skills](../../../../../docs/site/guides/add-design-and-review-skills.md)
...
[soft layer](../../../../../docs/site/terms.md#soft-layer-and-hard-layer): the agent reads it and may still
ignore it. When a [convention](../../../../../docs/site/terms.md#convention) must hold, make it a
[rule](../../../../../docs/site/terms.md#rule) with a [gate](../../../../../docs/site/terms.md#gate). Use a skill to teach the agent
...
- **posture** says how much the skill depends on
  [Claude Code](../../../../../docs/site/terms.md#claude-code). `portable` means any agent that reads files
...
- **operator-twin** is the path of a second copy that the getff team keeps in its own
  ...
  such second copy. That is the case for [getff](../../../../../docs/site/reference/B/getff.md): the team uses the very
