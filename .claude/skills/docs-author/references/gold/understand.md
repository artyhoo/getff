...
your code is clean. In the second, the [rule](../../../../../docs/site/terms.md#rule) is not running at all.
...
The proof is a [self-check](../../../../../docs/site/terms.md#self-check), and it has a simple shape: feed the
rule something bad on purpose and watch it go [red](../../../../../docs/site/terms.md#red-and-green). Then
...
[Stop a bad commit](../../../../../docs/site/learn/stop-a-bad-commit.md).
