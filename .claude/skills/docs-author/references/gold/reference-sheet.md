...
What each row means: [how to read a fact card](../../../../../docs/site/reference/B.md#how-to-read-a-fact-card).
...
This is one of the [skills](../../../../../docs/site/reference/B.md) getff installs. It is the
[skill](../../../../../docs/site/terms.md#skill) your agent loads when you ask it to enforce
something. It stops the agent from answering "I'll be careful" and points it at the
tool that can make the [rule](../../../../../docs/site/terms.md#rule) fail. You get the same advice whether
...
[soft layer](../../../../../docs/site/terms.md#soft-layer-and-hard-layer), so an agent may read it and
...
ones. On the `python` [lane](../../../../../docs/site/terms.md#lane) the skill still installs and the layer
