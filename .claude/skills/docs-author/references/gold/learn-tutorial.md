...
In the [quick start](../../../../../docs/site/quickstart-ts.md) you ran the linter by hand and saw a [rule](../../../../../docs/site/terms.md#rule)
[fire](../../../../../docs/site/terms.md#fire). That proves the rule works. It does not prove the rule
...
[gate](../../../../../docs/site/terms.md#gate) feels like from the inside.

You need a `ts-server` project with getff installed and the install committed. If you
do not have one, do the [quick start](../../../../../docs/site/quickstart-ts.md) first.
...
1. Add an endpoint helper that trusts its input. Put this in `src/routes/create-user.ts`:
   ...
   [convention](../../../../../docs/site/terms.md#convention) here is to call `.safeParse()` and handle the
...
The pre-commit hook is one [channel](../../../../../docs/site/terms.md#channel) of several. It is fast because
...
Next, read [Why a rule must prove it fires](../../../../../docs/site/understand/why-a-rule-must-prove-it-fires.md).
