...
**Single SSOT:** the helper lives at `.claude/skills/pipeline/helpers/update-cache.sh` only — no consumer mirror under `skills/pipeline/` per [install.sh:26](../../../../install.sh) authority.
