...
**These budgets do not replace the three convergence caps** — [`arch/SKILL.md:106`](../skills/arch/SKILL.md) (2 REVISE rounds), [`harvest/SKILL.md:91`](../skills/harvest/SKILL.md) (2 rounds → escalate), [`dispatcher/SKILL.md:220`](../skills/dispatcher/SKILL.md) (D6: 2 *consecutive* REVISE on unchanged scope). Those count failure-to-converge and reset on a GO or a scope change; this budget counts cumulative rounds and never resets. #1341 is the proof they are different counters — seven rounds with D6 never firing (`:243`).
