...
|---|---|---|
| astgrep | `.github/workflows/audit-self.yml:302` (`npm install -g @ast-grep/cli@…`, principles-meta-tests) + `:970` (same, install-sh-c) | `0.44.1` |
| ruff | `.github/workflows/audit-self.yml:312` (`pip install ruff==…`, principles-meta-tests) + `:968` (same, install-sh-c) | `0.15.21` |
