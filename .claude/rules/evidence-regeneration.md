...
> **Fires:** a freshness gate RED, or a first live-fired matrix cell.
...
|---|---|---|
| astgrep | `.github/workflows/audit-self.yml:294` (`npm install -g @ast-grep/cli@…`, principles-meta-tests) + `:936` (same, install-sh-c) | `0.44.1` |
| ruff | `.github/workflows/audit-self.yml:304` (`pip install ruff==…`, principles-meta-tests) + `:934` (same, install-sh-c) | `0.15.21` |
| rustc (CI) | `.github/workflows/audit-self.yml:333` (`rustup toolchain install …`) + `:334` (`rustup default …`) | `1.96.1` |
