...
|---|---|---|
| astgrep | `.github/workflows/audit-self.yml:294` (`npm install -g @ast-grep/cli@…`, principles-meta-tests) + `:930` (same, install-sh-c) | `0.44.1` |
| ruff | `.github/workflows/audit-self.yml:304` (`pip install ruff==…`, principles-meta-tests) + `:928` (same, install-sh-c) | `0.15.21` |
