...
# the AUTONOMY BLOCK below (the opt-in AIF_AUTONOMOUS=1 digest extension at inject-session-
# bootstrap.sh:63-65) — the always-on second delivery surface named in that rule's Class-B
