...
#      text — reuses the exact grep|tail|jq pattern from end-of-turn-reminder.sh:690-700.
...
# Path 2: agent_transcript_path JSONL — reuses end-of-turn-reminder.sh:690-700 pattern
if [ -z "$TEXT" ]; then
