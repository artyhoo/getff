...
#      text — reuses the exact grep|tail|jq pattern from end-of-turn-reminder.sh:657-667.
...
# Path 2: agent_transcript_path JSONL — reuses end-of-turn-reminder.sh:657-667 pattern
if [ -z "$TEXT" ]; then
