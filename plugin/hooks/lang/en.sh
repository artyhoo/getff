...
# Word-boundary character class for the glossary raw-word match — category-3 MATCH DATA
# (language-discipline.md §1), homed in the packs rather than the hook body: principle 22
