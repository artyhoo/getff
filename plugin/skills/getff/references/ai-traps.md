...
> **NOT authoritative for:** framework's project goal — see [README.md#why-this-exists](https://github.com/artyhoo/getff/blob/main/README.md#why-this-exists). Layer taxonomy — see [overview.md](overview.md). Audit-script pattern — see [self-testing-docs.md](self-testing-docs.md).
