...
### 1. Forward-check: per-layer coverage ([.claude/rules/phase-research-coverage.md](https://github.com/artyhoo/getff/blob/main/.claude/rules/phase-research-coverage.md) §1.7)
...
- [.claude/rules/phase-research-coverage.md](https://github.com/artyhoo/getff/blob/main/.claude/rules/phase-research-coverage.md) §1.7 — the §1.7 discipline.
